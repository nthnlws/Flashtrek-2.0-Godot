...
func _start_hail(player_ship_name: String) -> void:
	...
	if MissionManager.current_state == MissionManager.STATE.active_mission:
		if MissionManager.active_mission.target_planet_name == owning_planet_data.name:
...
func _beam_cargo(player_ship_name: String) -> void:
	if MissionManager.current_state == MissionManager.STATE.active_mission and MissionManager.active_mission.target_planet_name == owning_planet_data.name:
...
func _format_completion_message(mission: MissionData, ship_name: String) -> String:
	...
	match owning_planet_data.faction:
