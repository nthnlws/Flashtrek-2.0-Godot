...
var must_protect: bool = false

## Mission ship factory
static func generate_mission_ship_data(
	spawn_position:Vector2, faction:Utility.FACTION,
	difficulty:float, index:int, ship_type_param:Utility.SHIP_TYPES = Utility.SHIP_TYPES.Merchantman,
	is_hostile_param:bool = false, protect_status:bool = false) -> MissionShipData:
		...
		new_ship_data.must_protect = protect_status
